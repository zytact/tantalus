...
Rust owns the tray, closes and recreates the main window, and refreshes usage in the background. Healthy polling waits five minutes. Until every enabled provider is Ready, retries wait 5, 10, and 20 seconds and keep doubling up to five minutes.
