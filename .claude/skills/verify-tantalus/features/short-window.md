...
The main process maps Codex's exact 18,000-second window, Claude's `five_hour`, and Opencode's `usage.rolling` into the Short window. The allowance view renders it before other reported windows for each enabled provider.
